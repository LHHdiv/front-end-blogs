...
export default hopeTheme(
  {
    // 当前网站部署的域名地址
    hostname: "http://www.mashimaro.top/",
    repoLabel: "Gitee",
    // 是否在导航栏内显示仓库链接，默认为 `true`
    repoDisplay: true,
    author: {
      name: "LJK",
      url: "http://www.mashimaro.top/",
    },
    ...
    footer:
      'ICP备案号：<a href="https://beian.miit.gov.cn/" target="_blank">粤ICP备2023026675号-1</a>',
    displayFooter: true,
    ...
    plugins: {
      // 浅色主题列表
      // "ateliersulphurpool-light","coldark-cold",'coy',
      // 'duotone-light','ghcolors','gruvbox-light','material-light','one-light','vs'
      // 深色主题列表
      // 'atom-dark','cb','coldark-dark','dark',
      // 'dracula','duotone-dark','duotone-earth','duotone-forest',
      // 'duotone-sea','duotone-space','gruvbox-dark','holi','hopscotch',
      // 'lucario','material-dark','material-oceanic','night-owl','nord',
      // 'one-dark','pojoaque','shades-of-purple','solarized-dark-atom',
      // 'tomorrow','vsc-dark-plus','xonokai','z-touch'
      // 代码主题
      prismjs: {
        light: "vs",
        dark: "xonokai",
